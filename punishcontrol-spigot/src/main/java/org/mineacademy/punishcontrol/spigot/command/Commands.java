...
public class Commands {
  ...
  private final String PACKAGE_NAME = Bukkit.getServer().getClass().getPackage()
      .getName();
  private final String VERSION = PACKAGE_NAME
      .substring(PACKAGE_NAME.lastIndexOf(".") + 1);

  @SneakyThrows
  public void registerCommand(@NonNull final Command command) {
    final Field commandMapField = Bukkit.getServer().getClass()
