 ...
 */
public abstract class AbstractAsyncMenuPaged<T> extends Menu {

  /** The pages by the page number, containing a list of items */
  @Getter private final Map<Integer, List<T>> pages;
   ...
   */
  protected AbstractAsyncMenuPaged(final Iterable<T> pages) {
    this(null, pages);
  }
   ...
   */
  protected AbstractAsyncMenuPaged(final Menu parent, final Iterable<T> pages) {
   ...
   */
  protected AbstractAsyncMenuPaged(
      final Menu parent, final Iterable<T> pages, final boolean returnMakesNewInstance) {
   ...
   */
  @Deprecated
  protected AbstractAsyncMenuPaged(final int pageSize, final Iterable<T> pages) {
   ...
   */
  @Deprecated
  protected AbstractAsyncMenuPaged(final int pageSize, final Menu parent, final Iterable<T> pages) {
   ...
   */
  private AbstractAsyncMenuPaged(
        ...
        hasPages
            ? new Button() {
              ...
              public ItemStack getItem() {
                ...
                return ItemCreator.of(canGo ? CompMaterial.LIME_DYE : CompMaterial.GRAY_DYE)
        ...
        hasPages
            ? new Button() {
              ...
              public ItemStack getItem() {
                ...
                return ItemCreator.of(canGo ? CompMaterial.LIME_DYE : CompMaterial.GRAY_DYE)
                    .name(last ? "&7Last Page" : "Page " + (currentPage + 1) + " &8>>")
                    .build()
                    .make();
              }
            }
   ...
   *
   * <p>Use {@link ItemCreator} for easy creation.
   *
  ...
  /**
   * Return true if you want our system to add page/totalPages suffix after your title, true by
   * default
   *
   * @return
   */
  ...
  private List<T> getCurrentPageItems() {
    Valid.checkBoolean(
        ...
        "The menu has only " + pages.size() + " pages, not " + currentPage + "!");
