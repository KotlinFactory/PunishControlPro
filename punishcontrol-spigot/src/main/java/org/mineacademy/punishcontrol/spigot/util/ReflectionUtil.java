...
public final class ReflectionUtil {
  ...
  public Class<?> getClass(final String classname) throws ClassNotFoundException {
    final String path =
        classname
            .replace("{nms}", "net.minecraft.server." + getVersion())
            .replace("{obc}", "org.bukkit.craftbukkit." + getVersion())
  ...
  public Object getFieldValue(final Object instance, final String fieldName)
    ...
    final Map.Entry<Class, String> key =
        new AbstractMap.SimpleEntry<>(instance.getClass(), fieldName);
    final Field field =
        CACHED_FIELDS.computeIfAbsent(
            key,
            i -> {
              try {
  ...
  public void setValue(
      final Class c, final Object instance, final String field, final Object value) {
    try {
  ...
  public Object getFieldValue(
      final Class<?> superclass, final Object instance, final String fieldName)
