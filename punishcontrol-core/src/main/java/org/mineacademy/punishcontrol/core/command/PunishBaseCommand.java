...
public interface PunishBaseCommand<S> {
	...
	default void onCase3(@NonNull final S sender, @NonNull final UUID target, @NonNull final PunishDuration punishDuration) {

	}

	default void onCase4(@NonNull final S player,
