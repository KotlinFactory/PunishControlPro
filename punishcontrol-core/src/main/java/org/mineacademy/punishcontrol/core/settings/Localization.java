...
public final class Localization extends SimpleLocalization {
  ...
  public enum Time {
    ...
    YEAR(
        getOrSetDefault("Parts.Year", "Year"),
        getOrSetDefault(
            "Hash.Year.Hash",
    ...
    MONTH(
        getOrSetDefault("Parts.Month", "Month"),
        getOrSetDefault(
            "Hash.Month.Hash",
    ...
    DAY(getOrSetDefault("Parts.Day", "Day"), getOrSetDefault(
        "Hash.Day.Hash",
    ...
    HOUR(
        getOrSetDefault("Parts.Hour", "Hour"),
        getOrSetDefault(
            "Hash.Hour.Hash",
  ...
  public static final class Punish {
    ...
    public static Replacer KICK_MESSAGE;
    ...
    private static void init() {
      ...
      KICK_MESSAGE = getReplacer("Kick_Message");
    }
  }
}
